...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '5a2095d0-dead-4583-83e2-1ddc2e162cda' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('5d9e04d9-efa3-4e71-8909-681b89db0834');
      cy.get(`[data-cy="name"]`).should('have.value', '5d9e04d9-efa3-4e71-8909-681b89db0834');
