...
public class EstadoSeleccionDTO implements Serializable {
    ...
    public List<AsientoSeleccionadoDTO> getAsientosSeleccionados() {
        return asientosSeleccionados;
    }

    public void setAsientosSeleccionados(List<AsientoSeleccionadoDTO> asientosSeleccionados) {
    ...
    public static class AsientoSeleccionadoDTO implements Serializable {
